...
- **Pencarian Narasumber Cepat (Select2 Searchable)**: Mengintegrasikan Select2 pencarian otomatis pada pilihan dropdown "Pilih Ustadz / Narasumber Internal" di halaman tambah ([agenda/create.php](file:///apps/masjidagung/app/Views/dashboard/agenda/create.php)) dan ubah agenda ([agenda/edit.php](file:///apps/masjidagung/app/Views/dashboard/agenda/edit.php)).
