...
<head>
    ...
    <title>Tambah Pelaksana Shalat Jumat - <?= site_name() ?></title>
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="topbar">
            <div>
                <h1 class="h3 fw-bold mb-1 text-dark">Tambah Pelaksana Shalat Jumat Baru</h1>
                <p class="text-muted mb-0">Rilis data petugas salat Jumat mingguan.</p>
            </div>
        ...
        <div class="panel-card">
            <form action="<?= base_url('dashboard/jadwal-jumat/store') ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="row">
                    ...
                    <!-- Imam -->
                    <div class="col-md-4 mb-4">
                        <label for="imam_id" class="form-label">Imam Shalat <span class="text-danger">*</span></label>
                        <div class="input-group">
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control" id="keterangan" name="keterangan" rows="4" placeholder="Tuliskan pengumuman atau catatan tambahan (opsional)"><?= old('keterangan') ?></textarea>
                </div>

                <!-- Buttons -->
                <div class="d-flex gap-3 justify-content-end">
                    <a href="<?= base_url('dashboard/jadwal-jumat') ?>" class="btn btn-cancel">Batal</a>
                    <button type="submit" class="btn btn-submit">Simpan Jadwal <i class="fa-solid fa-save ms-2"></i></button>
                </div>
            </form>
        </div>
    </main>
