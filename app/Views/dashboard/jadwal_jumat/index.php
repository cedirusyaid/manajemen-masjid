...
<head>
    ...
    <title>Kelola Pelaksana Ibadah Shalat Jumat - <?= site_name() ?></title>
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="topbar">
            <div>
                <h1 class="h3 fw-bold mb-1 text-dark">Kelola Pelaksana Ibadah Shalat Jumat</h1>
                <p class="text-muted mb-0">Atur agenda khatib, imam, muadzin, dan rencana judul khotbah.</p>
            </div>
        ...
        <div class="panel-card">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h5 class="fw-bold mb-0 text-dark"><i class="fa-solid fa-calendar-day me-2 text-success"></i>Daftar Penjadwalan</h5>
                <a href="<?= base_url('dashboard/jadwal-jumat/create') ?>" class="btn btn-add">
                    ...
                    <tbody>
                        <?php if (!empty($jadwal_list)) : ?>
                            <?php foreach ($jadwal_list as $row) : ?>
                                <tr>
                                    <td class="fw-bold text-dark"><?= esc(date('d/m/Y', strtotime($row['tanggal']))) ?></td>
                                    <td><?= esc($row['khatib_nama']) ?></td>
                                    <td><?= esc($row['imam_nama']) ?></td>
                                    <td><?= esc($row['muadzin_nama']) ?></td>
                                    <td class="text-muted italic">"<?= esc($row['judul_khotbah']) ?: '-' ?>"</td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="<?= base_url('dashboard/jadwal-jumat/edit/' . $row['id']) ?>" class="btn-action btn-edit" title="Ubah">
                                                <i class="fa-solid fa-pencil"></i>
                                            </a>
                                            <a href="<?= base_url('dashboard/jadwal-jumat/delete/' . $row['id']) ?>" class="btn-action btn-delete" onclick="return confirm('Apakah Anda yakin ingin menghapus jadwal jumat ini?');" title="Hapus">
                        ...
                        <?php else : ?>
                            <tr>
                                <td colspan="6" class="text-center py-5 text-muted">
                                    ...
                                    Belum ada data jadwal petugas Jumat.
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
