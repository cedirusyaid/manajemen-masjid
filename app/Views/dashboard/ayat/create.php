...
<head>
    ...
    <title>Tambah Ayat Pilihan Display - <?= site_name() ?></title>
...
<body>
    ...
    <main class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 fw-bold mb-1 text-dark">Tambah Ayat Pilihan</h1>
                <p class="text-muted mb-0">Input ayat suci Al-Qur'an dan terjemahan untuk ditampilkan pada TV Display.</p>
            </div>
        ...
        <div class="card-panel">
            <form action="<?= base_url('dashboard/ayat/store') ?>" method="POST">
                <?= csrf_field() ?>

                <div class="row g-3 mb-3">
                    <div class="col-md-5">
                        <label for="surah" class="form-label">Nama Surah <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="surah" name="surah" placeholder="Contoh: Al-Baqarah, Ali Imran, An-Nur" value="<?= old('surah') ?>" required>
                    </div>
                    <div class="col-md-3">
                        <label for="nomor_ayat" class="form-label">Nomor Ayat <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="nomor_ayat" name="nomor_ayat" placeholder="Contoh: 153 atau 18-20" value="<?= old('nomor_ayat') ?>" required>
                    </div>
                    <div class="col-md-4">
                        <label for="tema" class="form-label">Tema / Pokok Bahasan</label>
                        <input type="text" class="form-control" id="tema" name="tema" placeholder="Contoh: Sabar & Shalat, Infak, Memakmurkan Masjid" value="<?= old('tema') ?>">
                    </div>
                </div>

                <div class="mb-4">
                    <label for="teks_arab" class="form-label">Teks Arab / Ayat Suci Al-Qur'an <span class="text-danger">*</span></label>
                    <textarea class="form-control arabic-input" id="teks_arab" name="teks_arab" rows="3" placeholder="Masukkan teks ayat dalam tulisan Arab berharakat..." required><?= old('teks_arab') ?></textarea>
                </div>

                <div class="mb-4">
                    <label for="terjemahan" class="form-label">Terjemahan Bahasa Indonesia <span class="text-danger">*</span></label>
                    <textarea class="form-control" id="terjemahan" name="terjemahan" rows="3" placeholder="Masukkan arti/terjemahan ayat..." required><?= old('terjemahan') ?></textarea>
                </div>
                ...
                <div class="row g-3 mb-4 align-items-center">
                    ...
                    <div class="col-md-6">
                        <div class="form-check form-switch mt-4">
                            ...
                            <label class="form-check-label fw-semibold text-dark" for="is_active">Aktifkan langsung pada TV Display</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-end gap-2 pt-3 border-top">
                    ...
                    <button type="submit" class="btn btn-primary px-4 py-2" style="background-color: var(--primary); border-color: var(--primary);">
                        <i class="fa-solid fa-save me-1"></i> Simpan Ayat Pilihan
                    </button>
                </div>
            </form>
        </div>
