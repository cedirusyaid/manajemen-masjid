...
<head>
    ...
    <title>Edit Catatan Pelayanan Jamaah - <?= site_name() ?></title>
...
<body>
    ...
    <main class="main-content">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                <h1 class="h3 fw-bold mb-1 text-dark">Edit Catatan Pelayanan Jamaah</h1>
                <p class="text-muted mb-0">Perbarui status dan tindak lanjut pelayanan jamaah.</p>
            </div>
        ...
        <div class="panel-card">
            <form action="<?= base_url('dashboard/pelayanan/update/' . $pelayanan['id']) ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        <select class="form-select" id="layanan_id" name="layanan_id" required>
                            ...
                            <?php foreach ($layanan_list as $lay) : ?>
                                <option value="<?= esc($lay['id']) ?>" <?= (old('layanan_id', $pelayanan['layanan_id']) == $lay['id']) ? 'selected' : '' ?>>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="date" class="form-control" id="tanggal" name="tanggal" value="<?= old('tanggal', $pelayanan['tanggal']) ?>" required>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-4">
                        ...
                        <input type="text" class="form-control" id="nama_pemohon" name="nama_pemohon" placeholder="Contoh: H. Ahmad Subardjo" value="<?= old('nama_pemohon', $pelayanan['nama_pemohon']) ?>" required>
                    </div>

                    <div class="col-md-4 mb-4">
                        <label for="nik_pemohon" class="form-label">NIK / KTP (Opsional)</label>
                        <input type="text" class="form-control" id="nik_pemohon" name="nik_pemohon" placeholder="16 Digit NIK" value="<?= old('nik_pemohon', $pelayanan['nik_pemohon']) ?>">
                    </div>

                    <div class="col-md-4 mb-4">
                        <label for="no_hp_pemohon" class="form-label">Nomor HP / WhatsApp</label>
                        <input type="text" class="form-control" id="no_hp_pemohon" name="no_hp_pemohon" placeholder="Contoh: 081234567890" value="<?= old('no_hp_pemohon', $pelayanan['no_hp_pemohon']) ?>">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        ...
                        <input type="text" class="form-control" id="alamat_pemohon" name="alamat_pemohon" placeholder="Contoh: Jl. Persatuan Raya No. 45, Sinjai Utara" value="<?= old('alamat_pemohon', $pelayanan['alamat_pemohon']) ?>">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        <textarea class="form-control" id="rincian_kebutuhan" name="rincian_kebutuhan" rows="4" placeholder="Jelaskan kebutuhan jamaah..." required><?= old('rincian_kebutuhan', $pelayanan['rincian_kebutuhan']) ?></textarea>
                    </div>

                    <div class="col-md-6 mb-4">
                        <label for="tindakan_petugas" class="form-label">Tindakan / Hasil Pelayanan Petugas</label>
                        <textarea class="form-control" id="tindakan_petugas" name="tindakan_petugas" rows="4" placeholder="Jelaskan realisasi tindakan pengurus..."><?= old('tindakan_petugas', $pelayanan['tindakan_petugas']) ?></textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-4">
                        ...
                        <select class="form-select" id="petugas_personil_id" name="petugas_personil_id">
                            ...
                            <?php foreach ($personil_list as $p) : ?>
                                <option value="<?= esc($p['id']) ?>" <?= old('petugas_personil_id', $pelayanan['petugas_personil_id']) == $p['id'] ? 'selected' : '' ?>>
                                    <?= esc($p['nama']) ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <input type="number" class="form-control" id="biaya_infaq" name="biaya_infaq" placeholder="0" value="<?= old('biaya_infaq', (int)$pelayanan['biaya_infaq']) ?>">
                    </div>
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <select class="form-select" id="status_layanan" name="status_layanan" required>
                            <option value="selesai" <?= old('status_layanan', $pelayanan['status_layanan']) === 'selesai' ? 'selected' : '' ?>>Selesai</option>
                            <option value="diproses" <?= old('status_layanan', $pelayanan['status_layanan']) === 'diproses' ? 'selected' : '' ?>>Sedang Diproses</option>
                            <option value="diajukan" <?= old('status_layanan', $pelayanan['status_layanan']) === 'diajukan' ? 'selected' : '' ?>>Baru Diajukan</option>
                            <option value="ditolak" <?= old('status_layanan', $pelayanan['status_layanan']) === 'ditolak' ? 'selected' : '' ?>>Ditolak</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="d-flex gap-3 justify-content-end mt-4">
                    ...
                    <button type="submit" class="btn btn-submit">Update Catatan Pelayanan <i class="fa-solid fa-save ms-2"></i></button>
                </div>
            </form>
        </div>
    </main>
