        ...
        <div class="panel-card">
            <form action="<?= base_url('dashboard/keuangan/store') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <select class="form-select" id="kategori" name="kategori" required>
                            ...
                            <option value="saldo_awal" <?= old('kategori') === 'saldo_awal' ? 'selected' : '' ?>>Saldo Awal / Modal Kas</option>
                    ...
                    <?php if (!empty($selected_kegiatan_id)) : ?>
                        <input type="hidden" name="kegiatan_id" value="<?= esc($selected_kegiatan_id) ?>">
                    <?php else : ?>
                ...
                <div class="d-flex gap-3 justify-content-end">
                    <?php if (!empty($selected_kegiatan_id)) : ?>
                        <a href="<?= base_url('dashboard/kepanitiaan/detail/' . esc($selected_kegiatan_id)) ?>" class="btn btn-cancel">Batal</a>
                    <?php else : ?>
