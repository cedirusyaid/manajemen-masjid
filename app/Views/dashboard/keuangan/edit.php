...
<head>
    ...
    <title>Ubah Transaksi Kas - Panel Admin</title>
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="topbar">
            <div>
                <h1 class="h3 fw-bold mb-1 text-dark">Ubah Transaksi Kas</h1>
                <p class="text-muted mb-0">Ubah rincian pencatatan buku kas umum masjid.</p>
            </div>
            ...
            <form action="<?= base_url('dashboard/keuangan/update/' . $kas['id']) ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="date" class="form-control" id="tanggal" name="tanggal" value="<?= old('tanggal', $kas['tanggal']) ?>" required>
                    </div>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <select class="form-select" id="tipe" name="tipe" required>
                            <option value="masuk" <?= old('tipe', $kas['tipe']) === 'masuk' ? 'selected' : '' ?>>Kas Masuk (Penerimaan)</option>
                            <option value="keluar" <?= old('tipe', $kas['tipe']) === 'keluar' ? 'selected' : '' ?>>Kas Keluar (Pengeluaran)</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <select class="form-select" id="kategori" name="kategori" required>
                            ...
                            <option value="saldo_awal" <?= old('kategori', $kas['kategori']) === 'saldo_awal' ? 'selected' : '' ?>>Saldo Awal / Modal Kas</option>
                            <option value="operasional" <?= old('kategori', $kas['kategori']) === 'operasional' ? 'selected' : '' ?>>Operasional & Pemeliharaan</option>
                            <option value="pembangunan" <?= old('kategori', $kas['kategori']) === 'pembangunan' ? 'selected' : '' ?>>Pembangunan Fisik</option>
                            <option value="zis" <?= old('kategori', $kas['kategori']) === 'zis' ? 'selected' : '' ?>>Zakat, Infaq, Shadaqah</option>
                            <option value="sosial" <?= old('kategori', $kas['kategori']) === 'sosial' ? 'selected' : '' ?>>Kegiatan Sosial / Jamaah</option>
                        </select>
                    </div>
                    ...
                    <input type="hidden" name="kegiatan_id" value="<?= esc($kas['kegiatan_id'] ?? '') ?>">
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 mb-4">
                        ...
                        <input type="text" class="form-control" id="keterangan" name="keterangan" placeholder="Contoh: Pembelian sajadah shaf depan / Infaq kotak jumat" value="<?= old('keterangan', $kas['keterangan']) ?>" required>
                    </div>
