...
<head>
    ...
    <title>Tambah Personel Baru - Panel Admin</title>
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="topbar">
            <div>
                <h1 class="h3 fw-bold mb-1 text-dark">Tambah Personel Baru</h1>
                <p class="text-muted mb-0">Masukkan data personal jamaah, pengurus, panitia, ustadz, atau petugas masjid.</p>
            </div>
        ...
        <div class="panel-card">
            <form action="<?= base_url('dashboard/personil/store') ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field() ?>
                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : '' ?>" id="nama" name="nama" value="<?= old('nama') ?>" placeholder="Masukkan nama lengkap beserta gelar jika ada" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('nik')) ? 'is-invalid' : '' ?>" id="nik" name="nik" value="<?= old('nik') ?>" maxlength="16" placeholder="Masukkan 16 digit NIK">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('no_hp')) ? 'is-invalid' : '' ?>" id="no_hp" name="no_hp" value="<?= old('no_hp') ?>" placeholder="Contoh: 08123456789">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" class="form-control <?= ($validation->hasError('email')) ? 'is-invalid' : '' ?>" id="email" name="email" value="<?= old('email') ?>" placeholder="Contoh: alamat@email.com">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex flex-wrap gap-3 mt-2">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="tipe_default[]" id="tipe_jamaah" value="jamaah" checked>
                                <label class="form-check-label" for="tipe_jamaah">Jamaah</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="tipe_default[]" id="tipe_pengurus" value="pengurus" <?= is_array(old('tipe_default')) && in_array('pengurus', old('tipe_default')) ? 'checked' : '' ?>>
                                <label class="form-check-label" for="tipe_pengurus">Pengurus</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="tipe_default[]" id="tipe_panitia" value="panitia" <?= is_array(old('tipe_default')) && in_array('panitia', old('tipe_default')) ? 'checked' : '' ?>>
                                <label class="form-check-label" for="tipe_panitia">Panitia</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="tipe_default[]" id="tipe_ustadz" value="ustadz" <?= is_array(old('tipe_default')) && in_array('ustadz', old('tipe_default')) ? 'checked' : '' ?>>
                                <label class="form-check-label" for="tipe_ustadz">Ustadz/Khatib</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="tipe_default[]" id="tipe_petugas" value="petugas" <?= is_array(old('tipe_default')) && in_array('petugas', old('tipe_default')) ? 'checked' : '' ?>>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control <?= ($validation->hasError('alamat')) ? 'is-invalid' : '' ?>" id="alamat" name="alamat" rows="3" placeholder="Masukkan alamat lengkap tinggal"><?= old('alamat') ?></textarea>
                        <div class="invalid-feedback"><?= $validation->getError('alamat') ?></div>
                    </div>

                    <!-- Foto Profil -->
                    <div class="col-md-12">
                        <label for="foto" class="form-label mb-2">Foto Profil (Akan dikonversi otomatis ke format WebP)</label>
                ...
                <div class="d-flex justify-content-end gap-3 border-top pt-4">
                    ...
                    <button type="submit" class="btn btn-submit">
                        <i class="fa-solid fa-floppy-disk me-2"></i> Simpan Data Personel
                    </button>
                </div>
            </form>
        </div>
