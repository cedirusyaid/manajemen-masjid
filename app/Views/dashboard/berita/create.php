...
<head>
    ...
    <title>Tulis Berita Baru - Panel Admin</title>
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="topbar">
            <div>
                <h1 class="h3 fw-bold mb-1 text-dark">Tulis Berita Baru</h1>
                <p class="text-muted mb-0">Publikasikan informasi bermanfaat untuk umat.</p>
            </div>
        ...
        <div class="panel-card">
            <form action="<?= base_url('dashboard/berita/store') ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field() ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 mb-4">
                        ...
                        <input type="text" class="form-control" id="judul" name="judul" placeholder="Tuliskan judul berita yang menarik" value="<?= old('judul') ?>" required>
                    </div>
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <select class="form-select" id="status" name="status" required>
                            ...
                            <option value="draft" <?= old('status') === 'draft' ? 'selected' : '' ?>>Simpan sebagai Draft (Draft)</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    <label for="banner" class="form-label">Gambar Sampul / Banner</label>
                    <input type="file" class="form-control" id="banner" name="banner" accept="image/png, image/jpeg, image/jpg, image/webp">
                    <div class="form-text text-muted">Format yang didukung: JPG, JPEG, PNG, WEBP. Sistem otomatis mengkonversi gambar ke format hemat data <strong>WebP</strong>.</div>
                </div>
                ...
                <div class="d-flex gap-3 justify-content-end">
                    ...
                    <button type="submit" class="btn btn-submit">Simpan & Terbitkan <i class="fa-solid fa-paper-plane ms-2"></i></button>
                </div>
            </form>
        </div>
    </main>
