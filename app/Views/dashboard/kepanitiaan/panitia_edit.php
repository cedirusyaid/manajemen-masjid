...
<head>
    ...
    <title>Ubah Panitia Kegiatan - <?= site_name() ?></title>
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="topbar">
            <div>
                <h1 class="h3 fw-bold mb-1 text-dark">Ubah Panitia Kegiatan</h1>
        ...
        <div class="panel-card">
            <form action="<?= base_url('dashboard/kepanitiaan/panitia/update/' . esc($panitia['id'])) ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="text" class="form-control" id="jabatan" name="jabatan" placeholder="Contoh: Ketua Panitia / Sekertaris / Anggota Acara" value="<?= old('jabatan', esc($panitia['jabatan'])) ?>" required>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        <select class="form-select" id="kegiatan_id" name="kegiatan_id" required>
                            ...
                            <?php foreach ($kegiatan_list as $kegiatan) : ?>
                                <option value="<?= esc($kegiatan['id']) ?>" <?= old('kegiatan_id', esc($panitia['kegiatan_id'])) == $kegiatan['id'] ? 'selected' : '' ?>>
                    ...
                    <div class="col-md-3 mb-4">
                        ...
                        <input type="number" class="form-control" id="urutan" name="urutan" placeholder="Contoh: 1" value="<?= old('urutan', esc($panitia['urutan'])) ?>">
                    </div>
                    ...
                    <div class="col-md-3 mb-4">
                        ...
                        <select class="form-select" id="parent_id" name="parent_id">
                            ...
                            <?php foreach ($panitia_list as $p_parent) : ?>
                                <option value="<?= esc($p_parent['id']) ?>" <?= old('parent_id', esc($panitia['parent_id'])) == $p_parent['id'] ? 'selected' : '' ?>>
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control" id="tugas" name="tugas" rows="4" placeholder="Tuliskan detail tanggung jawab atau tugas khusus panitia (opsional)"><?= old('tugas', esc($panitia['tugas'])) ?></textarea>
                </div>
