...
<body>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <select class="form-select" id="kegiatan_id" name="kegiatan_id" required>
                            ...
                            <?php foreach ($kegiatan_list as $kegiatan) : ?>
                                <option value="<?= esc($kegiatan['id']) ?>" <?= old('kegiatan_id', esc($current_kegiatan_id)) == $kegiatan['id'] ? 'selected' : '' ?>>
    ...
    <script>
        ...
        const currentJabatanId = "<?= old('jabatan_kegiatan_id', esc($panitia['jabatan_kegiatan_id'])) ?>";

        function updateJabatanDropdown(initial = false) {
            const kegiatanId = $('#kegiatan_id').val();
            const jabatanSelect = $('#jabatan_kegiatan_id');
            const selectedVal = initial ? currentJabatanId : jabatanSelect.val();
        ...
        $(document).ready(function() {
            ...
            updateJabatanDropdown(true);
            $('#kegiatan_id').on('change', function() {
                updateJabatanDropdown(false);
            });
        });
    </script>
</body>
