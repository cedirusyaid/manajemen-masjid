...
<body>
    ...
    <main class="main-content">
        ...
        <div class="topbar">
            <div>
                <h1 class="h3 fw-bold mb-1 text-dark">Tambah Kegiatan Baru</h1>
                <p class="text-muted mb-0">Buat data kegiatan masjid untuk penugasan kepanitiaan.</p>
            </div>
        ...
        <div class="panel-card">
            <form action="<?= base_url('dashboard/kepanitiaan/kegiatan/store') ?>" method="post">
                <?= csrf_field() ?>

                <div class="mb-4">
                    <label for="nama_kegiatan" class="form-label">Nama Kegiatan</label>
                    <input type="text" class="form-control" id="nama_kegiatan" name="nama_kegiatan" placeholder="Contoh: Panitia Ramadhan 1447 H / Tabligh Akbar Akbar" value="<?= old('nama_kegiatan') ?>" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control" id="deskripsi" name="deskripsi" rows="4" placeholder="Tuliskan keterangan detail kegiatan (opsional)"><?= old('deskripsi') ?></textarea>
                </div>

                <div class="d-flex gap-3 justify-content-end mt-4">
                    <a href="<?= base_url('dashboard/kepanitiaan') ?>" class="btn btn-cancel">Batal</a>
                    <button type="submit" class="btn btn-submit">Simpan Kegiatan <i class="fa-solid fa-save ms-2"></i></button>
                </div>
            </form>
        </div>
    </main>
