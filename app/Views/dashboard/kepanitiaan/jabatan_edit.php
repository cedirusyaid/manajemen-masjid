...
<head>
    ...
    <title>Ubah Jabatan Kepanitiaan - <?= site_name() ?></title>
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="topbar">
            <div>
                <h1 class="h3 fw-bold mb-1 text-dark">Ubah Jabatan Kegiatan</h1>
        ...
        <div class="panel-card">
            <form action="<?= base_url('dashboard/kepanitiaan/jabatan/update/' . esc($jabatan['id'])) ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        <select class="form-select" id="kegiatan_id" name="kegiatan_id" required>
                            ...
                            <?php foreach ($kegiatan_list as $kegiatan) : ?>
                                <option value="<?= esc($kegiatan['id']) ?>" <?= old('kegiatan_id', esc($jabatan['kegiatan_id'])) == $kegiatan['id'] ? 'selected' : '' ?>>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="text" class="form-control" id="nama_jabatan" name="nama_jabatan" placeholder="Contoh: Ketua Panitia / Sekertaris / Anggota Humas" value="<?= old('nama_jabatan', esc($jabatan['nama_jabatan'])) ?>" required>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        ...
                        <textarea class="form-control" id="tugas" name="tugas" rows="3" placeholder="Deskripsikan secara singkat tugas pokok posisi jabatan ini (Opsional)"><?= old('tugas', esc($jabatan['tugas'])) ?></textarea>
                    </div>
                </div>
    ...
    <script>
        ...
        function filterParentJabatan() {
            ...
            const filtered = rawJabatanList.filter(j => j.kegiatan_id === selectedKegiatan && j.id !== currentJabatanId);
            filtered.forEach(j => {
