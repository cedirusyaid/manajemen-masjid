...
<head>
    ...
    <title>Tambah Kelompok Kegiatan - <?= site_name() ?></title>
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="topbar">
            <div>
                <h1 class="h3 fw-bold mb-1 text-dark">Tambah Kelompok Kegiatan</h1>
                <p class="text-muted mb-0">Buat kelompok kepanitiaan baru di bawah kegiatan.</p>
            </div>
        ...
        <div class="panel-card bg-white border-0 shadow-sm rounded-4 p-4">
            <form action="<?= base_url('dashboard/kepanitiaan/kelompok/store') ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" id="nama_kelompok" name="nama_kelompok" placeholder="Contoh: Kelompok Qurban Sapi 1 / Kelompok Penyedia Buka Puasa Hari 1" value="<?= old('nama_kelompok') ?>" required>
                    <small class="text-muted mt-1 d-block">Tuliskan nama kelompok secara spesifik.</small>
                </div>

                <div class="mb-4">
                    <label for="keterangan" class="form-label">Keterangan / Catatan Kelompok</label>
                    <textarea class="form-control" id="keterangan" name="keterangan" rows="4" placeholder="Misalnya: Iuran qurban @ Rp 3.500.000 / Kelompok jemaah dusun A"><?= old('keterangan') ?></textarea>
                </div>

                <div class="d-flex gap-3 justify-content-end mt-4">
                    <a href="<?= base_url('dashboard/kepanitiaan/detail/' . esc($kegiatan['id'])) ?>" class="btn btn-cancel">Batal</a>
                    <button type="submit" class="btn btn-submit">Simpan Kelompok <i class="fa-solid fa-save ms-2"></i></button>
                </div>
            </form>
        </div>
    </main>
