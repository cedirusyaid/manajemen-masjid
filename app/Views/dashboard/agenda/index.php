...
<head>
    ...
    <title>Kelola Jadwal Pengajian - <?= site_name() ?></title>
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="topbar">
            <div>
                <h1 class="h3 fw-bold mb-1 text-dark">Jadwal Pengajian & Kajian</h1>
                <p class="text-muted mb-0">Kelola dan publikasikan jadwal pengajian rutin, kajian tematik, dan tabligh akbar masjid.</p>
            </div>
        ...
        <div class="panel-card">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h5 class="fw-bold mb-0 text-dark"><i class="fa-solid fa-book-open-reader me-2 text-success"></i>Daftar Agenda Pengajian</h5>
                <a href="<?= base_url('dashboard/agenda/create') ?>" class="btn btn-add">
                    <i class="fa-solid fa-plus me-2"></i> Jadwalkan Kajian Baru
                </a>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="<?= base_url('dashboard/agenda/edit/' . $row['id']) ?>" class="btn-action btn-edit" title="Ubah">
                                                <i class="fa-solid fa-pencil"></i>
                                            </a>
                                            <a href="<?= base_url('dashboard/agenda/delete/' . $row['id']) ?>" class="btn-action btn-delete" onclick="return confirm('Apakah Anda yakin ingin menghapus agenda ini?');" title="Hapus">
                        ...
                        <?php else : ?>
                            <tr>
                                <td colspan="6" class="text-center py-5 text-muted">
                                    <i class="fa-regular fa-calendar-minus d-block fs-3 mb-2"></i>
                                    Belum ada jadwal kajian/pengajian yang diterbitkan.
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
