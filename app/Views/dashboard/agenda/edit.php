            ...
            <form action="<?= base_url('dashboard/agenda/update/' . $agenda['id']) ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="d-flex flex-wrap gap-4 p-3 bg-light rounded-3 border">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="tipe_jadwal" id="tipe_sekali" value="sekali" <?= old('tipe_jadwal', $agenda['tipe_jadwal'] ?? 'sekali') === 'sekali' ? 'checked' : '' ?> onchange="toggleJadwalType()">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="tipe_jadwal" id="tipe_rutin" value="rutin" <?= old('tipe_jadwal', $agenda['tipe_jadwal'] ?? '') === 'rutin' ? 'checked' : '' ?> onchange="toggleJadwalType()">
                    ...
                    <div class="col-md-3" id="wrapper_tanggal_sekali">
                        ...
                        <input type="date" class="form-control <?= ($validation->hasError('tanggal')) ? 'is-invalid' : '' ?>" id="tanggal" name="tanggal" value="<?= old('tanggal', $agenda['tanggal']) ?>">
                    ...
                    <div class="col-md-3 d-none" id="wrapper_hari_rutin">
                        ...
                        <select class="form-select" id="hari_rutin" name="hari_rutin">
                            <option value="ahad" <?= old('hari_rutin', $agenda['hari_rutin'] ?? '') === 'ahad' ? 'selected' : '' ?>>Ahad (Minggu)</option>
                            <option value="senin" <?= old('hari_rutin', $agenda['hari_rutin'] ?? '') === 'senin' ? 'selected' : '' ?>>Senin</option>
                            <option value="selasa" <?= old('hari_rutin', $agenda['hari_rutin'] ?? '') === 'selasa' ? 'selected' : '' ?>>Selasa</option>
                            <option value="rabu" <?= old('hari_rutin', $agenda['hari_rutin'] ?? '') === 'rabu' ? 'selected' : '' ?>>Rabu</option>
                            <option value="kamis" <?= old('hari_rutin', $agenda['hari_rutin'] ?? '') === 'kamis' ? 'selected' : '' ?>>Kamis</option>
                            <option value="jumat" <?= old('hari_rutin', $agenda['hari_rutin'] ?? '') === 'jumat' ? 'selected' : '' ?>>Jumat</option>
                            <option value="sabtu" <?= old('hari_rutin', $agenda['hari_rutin'] ?? '') === 'sabtu' ? 'selected' : '' ?>>Sabtu</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-3 d-none" id="wrapper_pekan_rutin">
                        ...
                        <select class="form-select" id="pekan_rutin" name="pekan_rutin">
                            <option value="1,3" <?= old('pekan_rutin', $agenda['pekan_rutin'] ?? '1,3') === '1,3' ? 'selected' : '' ?>>Pekan Ke-1 & Ke-3 (Setiap Bulan)</option>
                            <option value="2,4" <?= old('pekan_rutin', $agenda['pekan_rutin'] ?? '') === '2,4' ? 'selected' : '' ?>>Pekan Ke-2 & Ke-4 (Setiap Bulan)</option>
                            <option value="1" <?= old('pekan_rutin', $agenda['pekan_rutin'] ?? '') === '1' ? 'selected' : '' ?>>Pekan Ke-1 Saja</option>
                            <option value="2" <?= old('pekan_rutin', $agenda['pekan_rutin'] ?? '') === '2' ? 'selected' : '' ?>>Pekan Ke-2 Saja</option>
                            <option value="3" <?= old('pekan_rutin', $agenda['pekan_rutin'] ?? '') === '3' ? 'selected' : '' ?>>Pekan Ke-3 Saja</option>
                            <option value="4" <?= old('pekan_rutin', $agenda['pekan_rutin'] ?? '') === '4' ? 'selected' : '' ?>>Pekan Ke-4 Saja</option>
                            <option value="setiap_pekan" <?= old('pekan_rutin', $agenda['pekan_rutin'] ?? '') === 'setiap_pekan' ? 'selected' : '' ?>>Setiap Pekan (Mingguan)</option>
                        </select>
                    </div>
