...
<head>
    ...
    <title>Ubah Periode Kepengurusan - <?= site_name() ?></title>
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="topbar">
            <div>
                <h1 class="h3 fw-bold mb-1 text-dark">Ubah Periode Kepengurusan</h1>
                <p class="text-muted mb-0">Perbarui rincian masa bakti kepengurusan masjid.</p>
            </div>
        ...
        <div class="panel-card">
            <form action="<?= base_url('dashboard/kepengurusan/periode/update/' . esc($periode['id'])) ?>" method="post">
                <?= csrf_field() ?>

                <div class="mb-4">
                    <label for="nama_periode" class="form-label">Nama Periode</label>
                    <input type="text" class="form-control" id="nama_periode" name="nama_periode" placeholder="Contoh: Periode 2026 - 2031" value="<?= old('nama_periode', esc($periode['nama_periode'])) ?>" required>
                </div>

                <div class="row">
                    <div class="col-md-6 mb-4">
                        <label for="tahun_mulai" class="form-label">Tahun Mulai</label>
                        <input type="number" class="form-control" id="tahun_mulai" name="tahun_mulai" placeholder="Contoh: 2026" value="<?= old('tahun_mulai', esc($periode['tahun_mulai'])) ?>" required>
                    </div>

                    <div class="col-md-6 mb-4">
                        <label for="tahun_selesai" class="form-label">Tahun Selesai</label>
                        <input type="number" class="form-control" id="tahun_selesai" name="tahun_selesai" placeholder="Contoh: 2031" value="<?= old('tahun_selesai', esc($periode['tahun_selesai'])) ?>" required>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <select class="form-select" id="status" name="status" required>
                        <option value="tidak_aktif" <?= old('status', esc($periode['status'])) == 'tidak_aktif' ? 'selected' : '' ?>>Tidak Aktif</option>
                        <option value="aktif" <?= old('status', esc($periode['status'])) == 'aktif' ? 'selected' : '' ?>>Aktif (Menonaktifkan periode aktif lain)</option>
                    </select>
                </div>
