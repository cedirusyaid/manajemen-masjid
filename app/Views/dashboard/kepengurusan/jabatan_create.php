...
<head>
    ...
    <title>Tambah Jabatan Kepengurusan - <?= site_name() ?></title>
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="topbar">
            <div>
                <h1 class="h3 fw-bold mb-1 text-dark">Tambah Jabatan Kepengurusan</h1>
                <p class="text-muted mb-0">Definisikan posisi jabatan struktur kepengurusan baru.</p>
            </div>
        ...
        <div class="panel-card">
            <form action="<?= base_url('dashboard/kepengurusan/jabatan/store') ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        <select class="form-select" id="periode_id" name="periode_id" required>
                            ...
                            <?php foreach ($periode_list as $periode) : ?>
                                <option value="<?= esc($periode['id']) ?>" <?= old('periode_id', $selected_periode) == $periode['id'] ? 'selected' : '' ?>>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="text" class="form-control" id="nama_jabatan" name="nama_jabatan" placeholder="Contoh: Ketua Umum / Anggota Humas / Pembina" value="<?= old('nama_jabatan') ?>" required>
                    </div>
                </div>
    ...
    <script>
        ...
        function filterParentJabatan() {
            ...
            const filtered = rawJabatanList.filter(j => j.periode_id === selectedPeriode);
            filtered.forEach(j => {
